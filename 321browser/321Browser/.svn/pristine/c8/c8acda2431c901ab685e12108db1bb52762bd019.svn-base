...
import cn.hi321.browser.model.UrlSuggestionItemComparator;
...
public class BookmarksProviderWrapper {
	...
	private static final Uri INTERNAL_BOOKMARKS_URI = Uri.parse("content://" + BookmarksContentProvider.AUTHORITY + "/" + BookmarksContentProvider.BOOKMARKS_TABLE);
...
//         ContentResolver cr = getContentResolver();
         //向浏览器添加该书签
         Uri uri = contentResolver.insert(android.provider.Browser.BOOKMARKS_URI, inputValue);
...
//		String[] colums = null;
//		if (id != -1) {
//			 colums = new String[] { Browser.BookmarkColumns._ID };
//			 whereClause = Browser.BookmarkColumns._ID + " = " + id;
//
